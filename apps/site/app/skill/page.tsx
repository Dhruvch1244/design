...
const REFERENCE_DOCS = [
  ...
  },
  {
    ...
    body: "The real 36 UI components plus utils, sourced from packages/registry/registry.json and each component's actual source — real prop names, real variants.",
  },
  {
